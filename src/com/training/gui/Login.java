...
public class Login extends JFrame {
	...
	public Login() {
		...
		contentPaneLogin.add(textUsername);
		...
		contentPaneLogin.add(btnCancel);
		
		textPassword = new JPasswordField();
		textPassword.setBounds(189, 103, 126, 20);
		contentPaneLogin.add(textPassword);
